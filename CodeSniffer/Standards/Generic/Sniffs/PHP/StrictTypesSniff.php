<?php
/**
 * Generic_Sniffs_PHP_StrictTypesSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    Craig Berry <craig@redtally.com.au>
 ...
 * Generic_Sniffs_PHP_StrictTypesSniff.
 *
 * Ensures that declare(strict_types=1); is set on each page.
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    Craig Berry <craig@redtally.com.au>
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Generic_Sniffs_PHP_StrictTypesSniff implements PHP_CodeSniffer_Sniff
{
